.class public final Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;
...
.method public constructor <init>()V
    ...
    .line 49
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    .line 50
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
...
.method private checkUserChoice()Z
    ...
    iget v8, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    .line 211
    :cond_0
    iget-object v8, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;

    invoke-static {v8}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;->getInstance(Landroid/content/Context;)Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;

    move-result-object v0

    .line 212
    .local v0, "bluetoothManager":Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;
    if-nez v0, :cond_1
    ...
    .line 218
    .local v2, "cachedDeviceManager":Lcom/android/cyanogenmod/settings/bluetooth/CachedBluetoothDeviceManager;
    iget-object v8, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v8}, Lcom/android/cyanogenmod/settings/bluetooth/CachedBluetoothDeviceManager;->findDevice(Landroid/bluetooth/BluetoothDevice;)Lcom/android/cyanogenmod/settings/bluetooth/CachedBluetoothDevice;
    ...
    .line 233
    :cond_5
    invoke-direct {p0, v11}, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
    ...
    .line 236
    invoke-direct {p0, v7}, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
...
.method private getNotificationTag(I)Ljava/lang/String;
    ...
    .line 190
    :cond_0
    iget v0, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
...
.method private sendReplyIntentToReceiver(Z)V
    ...
    iget-object v1, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget v2, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 272
    iget-object v1, p0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
    ...
    invoke-static {v14}, Lcom/android/cyanogenmod/settings/Utils;->isManagedProfile(Landroid/os/UserManager;)Z
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iput v0, v1, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;

    .line 87
    invoke-direct/range {p0 .. p0}, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->checkUserChoice()Z
    ...
    const-class v16, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionActivity;
    ...
    iget v0, v0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    invoke-static {v0, v6}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;->shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1}, Lcom/android/cyanogenmod/settings/bluetooth/BluetoothPermissionRequest;->getNotificationTag(I)Ljava/lang/String;
