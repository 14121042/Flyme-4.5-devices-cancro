.class final Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;
...
.method static synthetic access$000(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .prologue
    .line 29
    invoke-static {p0}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;->getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method static persistDiscoveringTimestamp(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences$1;

    invoke-direct {v1, p0}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences$1;-><init>(Landroid/content/Context;)V
...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 64
    .local v8, "manager":Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;
    if-nez v8, :cond_0
    ...
    .line 70
    :cond_0
    invoke-virtual {v8}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
    ...
    .line 93
    :cond_3
    invoke-virtual {v8}, Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothManager;->getBluetoothAdapter()Lcom/android/cyanogenmod/settings/bluetooth/LocalBluetoothAdapter;
