.class public Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;
...
.method public static show(Lcom/android/cyanogenmod/settings/DataUsageSummary;)V
    ...
    .line 1998
    new-instance v1, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;

    invoke-direct {v1}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;-><init>()V

    .line 1999
    .local v1, "dialog":Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 2000
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 2006
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 2007
    .local v7, "context":Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    new-instance v0, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/cyanogenmod/settings/DataUsageSummary$WarningEditorFragment;Landroid/widget/NumberPicker;Lcom/android/cyanogenmod/settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/cyanogenmod/settings/DataUsageSummary;)V
