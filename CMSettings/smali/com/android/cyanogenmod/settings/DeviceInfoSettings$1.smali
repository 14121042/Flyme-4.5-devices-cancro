.class final Lcom/android/cyanogenmod/settings/DeviceInfoSettings$1;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/cyanogenmod/settings/DeviceInfoSettings;
.end annotation
...
.method public getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lcom/android/cyanogenmod/settings/DeviceInfoSettings$1;->isPropertyMissing(Ljava/lang/String;)Z
    ...
    .line 529
    :cond_2
    invoke-static {p1}, Lcom/android/cyanogenmod/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-static {p1}, Lcom/android/cyanogenmod/settings/Utils;->showSimCardTile(Landroid/content/Context;)Z
    ...
    .line 533
    :cond_3
    # invokes: Lcom/android/cyanogenmod/settings/DeviceInfoSettings;->getFeedbackReporterPackage(Landroid/content/Context;)Ljava/lang/String;
    invoke-static {p1}, Lcom/android/cyanogenmod/settings/DeviceInfoSettings;->access$000(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/cyanogenmod/settings/DeviceInfoSettings$1;->checkIntentAction(Landroid/content/Context;Ljava/lang/String;)Z
