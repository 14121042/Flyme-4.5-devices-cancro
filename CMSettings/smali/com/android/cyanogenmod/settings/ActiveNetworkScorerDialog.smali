.class public final Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;
...
.method private buildDialog()Z
    ...
    .line 77
    :cond_0
    iget-object v6, p0, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->setResult(I)V
    ...
    iget-object v3, p0, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    .line 94
    .local v3, "p":Lcom/android/internal/app/AlertController$AlertParams;
    const v6, 0x7f0907e5

    invoke-virtual {p0, v6}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->getString(I)Ljava/lang/String;
    ...
    .line 106
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->setupAlert()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->setResult(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 49
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->getIntent()Landroid/content/Intent;
    ...
    iput-object v1, p0, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;

    .line 52
    invoke-direct {p0}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->buildDialog()Z
    ...
    .line 53
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/ActiveNetworkScorerDialog;->finish()V
