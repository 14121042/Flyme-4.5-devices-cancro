.class public final Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$RecognizerInfo;,
        Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$InteractionInfo;,
        Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$BaseInfo;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableInteractionInfos:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableRecognizerInfos:Ljava/util/ArrayList;

    .line 99
    iput-object p1, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mContext:Landroid/content/Context;

    .line 101
    iget-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableVoiceInteractions:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
...
.method public buildUi()V
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mContext:Landroid/content/Context;
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mCurrentVoiceInteraction:Landroid/content/ComponentName;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableVoiceInteractions:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableInteractionInfos:Ljava/util/ArrayList;

    move-object/from16 v19, v0

    new-instance v20, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$InteractionInfo;
    ...
    invoke-direct {v0, v1, v9}, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$InteractionInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/service/voice/VoiceInteractionServiceInfo;)V
    ...
    iput-object v0, v1, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mCurrentRecognizer:Landroid/content/ComponentName;

    .line 157
    :goto_3
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableRecognizerInfos:Ljava/util/ArrayList;

    move-object/from16 v19, v0

    new-instance v20, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$RecognizerInfo;
    ...
    invoke-direct {v0, v1, v2, v15}, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper$RecognizerInfo;-><init>(Landroid/content/pm/PackageManager;Landroid/content/pm/ServiceInfo;Ljava/lang/String;)V
...
.method public hasItems()Z
    ...
    .prologue
    .line 110
    iget-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableVoiceInteractions:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/cyanogenmod/settings/voice/VoiceInputHelper;->mAvailableRecognition:Ljava/util/List;
