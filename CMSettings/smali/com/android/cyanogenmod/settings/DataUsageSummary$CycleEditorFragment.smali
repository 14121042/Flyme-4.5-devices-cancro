.class public Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;
...
.method public static show(Lcom/android/cyanogenmod/settings/DataUsageSummary;)V
    ...
    .line 1939
    new-instance v1, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;

    invoke-direct {v1}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;-><init>()V

    .line 1940
    .local v1, "dialog":Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 1941
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 1947
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 1948
    .local v7, "context":Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {v3, v4}, Lcom/android/cyanogenmod/settings/net/NetworkPolicyEditor;->getPolicyCycleDay(Landroid/net/NetworkTemplate;)I
    ...
    .line 1968
    const v11, 0x7f090bc1

    new-instance v0, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment$1;-><init>(Lcom/android/cyanogenmod/settings/DataUsageSummary$CycleEditorFragment;Landroid/widget/NumberPicker;Lcom/android/cyanogenmod/settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/cyanogenmod/settings/DataUsageSummary;)V
