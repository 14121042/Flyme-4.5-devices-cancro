.class public Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$SelectAccountListAdapter;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->TAG:Ljava/lang/String;

    .line 56
    const-string v0, "preferred_sim"

    sput-object v0, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->PREFERRED_SIM:Ljava/lang/String;

    .line 57
    const-string v0, "dialog_type"

    sput-object v0, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->DIALOG_TYPE_KEY:Ljava/lang/String;
...
.method static synthetic access$000(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;I)Landroid/telecom/PhoneAccountHandle;
    .locals 1
    .param p0, "x0"    # Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;
    .param p1, "x1"    # I

    .prologue
    .line 53
    invoke-direct {p0, p1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->subscriptionIdToPhoneAccountHandle(I)Landroid/telecom/PhoneAccountHandle;
...
.method static synthetic access$100(Landroid/content/Context;I)V
    ...
    .prologue
    .line 53
    invoke-static {p0, p1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->setDefaultDataSubId(Landroid/content/Context;I)V
...
.method static synthetic access$200(Landroid/content/Context;I)V
    ...
    .prologue
    .line 53
    invoke-static {p0, p1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->setDefaultSmsSubId(Landroid/content/Context;I)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;Landroid/telecom/PhoneAccountHandle;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;
    ...
    .prologue
    .line 53
    invoke-direct {p0, p1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->setUserSelectedOutgoingPhoneAccount(Landroid/telecom/PhoneAccountHandle;)V
...
.method private displayPreferredDialog(I)V
    ...
    .prologue
    .line 86
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    .line 87
    .local v2, "res":Landroid/content/res/Resources;
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    .line 88
    .local v1, "context":Landroid/content/Context;
    invoke-static {v1, p1}, Lcom/android/cyanogenmod/settings/Utils;->findRecordBySlotId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
    ...
    new-instance v5, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$1;

    invoke-direct {v5, p0, v3, v1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$1;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;Landroid/telephony/SubscriptionInfo;Landroid/content/Context;)V
    ...
    new-instance v5, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$2;

    invoke-direct {v5, p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$2;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;)V
    ...
    .line 119
    :cond_0
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->finish()V
...
.method public createDialog(Landroid/content/Context;I)Landroid/app/Dialog;
    ...
    :goto_0
    new-instance v23, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$3;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$3;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;ILjava/util/List;Landroid/content/Context;)V

    .line 199
    .local v23, "selectionListener":Landroid/content/DialogInterface$OnClickListener;
    new-instance v17, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$4;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$4;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-static {v0, v6}, Lcom/android/cyanogenmod/settings/Utils;->findRecordBySubId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
    ...
    new-instance v5, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$SelectAccountListAdapter;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$SelectAccountListAdapter;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;Ljava/util/List;Landroid/content/Context;I[Ljava/lang/String;I)V
    ...
    .line 273
    new-instance v6, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$5;

    move-object/from16 v0, p0

    invoke-direct {v6, v0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity$5;-><init>(Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 67
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->getIntent()Landroid/content/Intent;
    ...
    sget-object v2, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->DIALOG_TYPE_KEY:Ljava/lang/String;
    ...
    .line 74
    :pswitch_0
    invoke-virtual {p0, p0, v0}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->createDialog(Landroid/content/Context;I)Landroid/app/Dialog;
    ...
    .line 77
    :pswitch_1
    sget-object v2, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->PREFERRED_SIM:Ljava/lang/String;

    invoke-virtual {v1, v2}, Landroid/os/Bundle;->getInt(Ljava/lang/String;)I

    move-result v2

    invoke-direct {p0, v2}, Lcom/android/cyanogenmod/settings/sim/SimDialogActivity;->displayPreferredDialog(I)V
