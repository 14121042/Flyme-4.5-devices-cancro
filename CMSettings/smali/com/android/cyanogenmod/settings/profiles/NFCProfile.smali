.class public Lcom/android/cyanogenmod/settings/profiles/NFCProfile;
...
.method private clearPreviouslySelectedProfile()V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
...
.method private getPreviouslySelectedProfile()Lcyanogenmod/app/Profile;
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    .line 137
    iget-object v3, p0, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method private handleProfileMimeType([B)V
    ...
    .line 87
    invoke-static {p1}, Lcom/android/cyanogenmod/settings/profiles/NFCProfileUtils;->toUUID([B)Ljava/util/UUID;

    move-result-object v4

    .line 89
    .local v4, "profileUuid":Ljava/util/UUID;
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 94
    iget-object v6, p0, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    const-class v6, Lcom/android/cyanogenmod/settings/profiles/NFCProfileSelect;
    ...
    .line 102
    invoke-virtual {p0, v2}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->startActivity(Landroid/content/Intent;)V
    ...
    .line 106
    :cond_3
    invoke-direct {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->saveCurrentProfile()V

    .line 107
    invoke-direct {p0, v4}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->switchTo(Ljava/util/UUID;)V

    goto :goto_1

    .line 109
    :cond_4
    invoke-direct {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getPreviouslySelectedProfile()Lcyanogenmod/app/Profile;
    ...
    invoke-direct {p0, v6}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->switchTo(Ljava/util/UUID;)V

    .line 112
    invoke-direct {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->clearPreviouslySelectedProfile()V
...
.method private saveCurrentProfile()V
    ...
    .prologue
    .line 149
    iget-object v2, p0, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
...
.method private switchTo(Ljava/util/UUID;)V
    ...
    .line 120
    iget-object v1, p0, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 128
    invoke-static {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfileUtils;->vibrate(Landroid/content/Context;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method protected onResume()V
    ...
    .line 64
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->getIntent()Landroid/content/Intent;
    ...
    .line 77
    invoke-direct {p0, v7}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->handleProfileMimeType([B)V
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/cyanogenmod/settings/profiles/NFCProfile;->finish()V
