.class public Lcom/android/cyanogenmod/settings/location/RecentLocationApps;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;
    }
.end annotation
...
# instance fields
.field private final mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 48
    const-class v0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lcom/android/cyanogenmod/settings/SettingsActivity;)V
    .locals 1
    .param p1, "activity"    # Lcom/android/cyanogenmod/settings/SettingsActivity;
    ...
    .line 57
    iput-object p1, p0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;

    .line 58
    invoke-virtual {p1}, Lcom/android/cyanogenmod/settings/SettingsActivity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 59
    return-void
.end method

.method static synthetic access$000(Lcom/android/cyanogenmod/settings/location/RecentLocationApps;)Lcom/android/cyanogenmod/settings/SettingsActivity;
    .locals 1
    .param p0, "x0"    # Lcom/android/cyanogenmod/settings/location/RecentLocationApps;

    .prologue
    .line 47
    iget-object v0, p0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;

    return-object v0
.end method

.method private createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;
    .locals 2
    ...
    .prologue
    .line 88
    new-instance v0, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;

    iget-object v1, p0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;

    invoke-direct {v0, v1, p4}, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 89
    .local v0, "pref":Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;
    invoke-virtual {v0, p1}, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 90
    invoke-virtual {v0, p2}, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;->setSummary(I)V

    .line 96
    :goto_0
    invoke-virtual {v0, p5}, Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
    ...
    .line 170
    sget-object v4, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;
    ...
    .line 183
    .local v19, "preference":Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;
    :try_start_0
    ...
    iget-object v4, v0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;

    invoke-virtual {v4}, Lcom/android/cyanogenmod/settings/SettingsActivity;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, v0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 203
    :cond_6
    new-instance v9, Lcom/android/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;
    ...
    invoke-direct {v9, v0, v1, v2}, Lcom/android/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;-><init>(Lcom/android/cyanogenmod/settings/location/RecentLocationApps;Ljava/lang/String;Landroid/os/UserHandle;)V

    move-object/from16 v4, p0

    invoke-direct/range {v4 .. v9}, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/cyanogenmod/settings/location/DimmableIconPreference;
    :try_end_0
...
.method public getAppList()Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/android/cyanogenmod/settings/SettingsActivity;

    move-object/from16 v17, v0

    const-string v18, "appops"

    invoke-virtual/range {v17 .. v18}, Lcom/android/cyanogenmod/settings/SettingsActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v15, v8, v9, v7}, Lcom/android/cyanogenmod/settings/location/RecentLocationApps;->getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
